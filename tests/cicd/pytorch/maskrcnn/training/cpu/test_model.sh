...
echo "Setup PyTorch Test Enviroment for MaskRCNN Training"

PRECISION=$1
OUTPUT_DIR=${OUTPUT_DIR-"$(pwd)/tests/cicd/pytorch/maskrcnn/training/cpu/output/${PRECISION}"}
is_lkg_drop=$2
DATASET_DIR=$3
...
# Install dependency
cd models_v2/pytorch/maskrcnn/training/cpu
MODEL_DIR=$(pwd)
./setup.sh
