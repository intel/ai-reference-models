...
if __name__ == '__main__':
    ...
    ap.add_argument("-i", "--images_path", required=True, help="Path to COCO validation directory")
    args = vars(ap.parse_args())
    
    SERVER_URL = 'http://localhost:8501/v1/models/rfcn:predict'
    IMAGES_PATH = args['images_path'] # Edit this to your COCO validation directory
