...
def get_parser():
    ...
    parser.add_argument('--input', default=None, help='path to read CSV output from SMI tool')
    parser.add_argument('--output', default=None, help='JSON file to write (or append to if already exists) SMI data to')
    parser.add_argument('--platform', help='System on which telemetry is being collected', default='Flex', choices=platform_choices)
