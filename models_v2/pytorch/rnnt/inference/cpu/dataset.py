...
class DistributedBucketBatchSampler(Sampler):
    ...
    def __iter__(self):
        ...
        for bucket in range(self.num_buckets):
            ...
            indices[bucket_start:bucket_end] = indices[bucket_start:bucket_end][
                torch.randperm(bucket_end - bucket_start, generator=g)
            ]
...
class AudioToTextDataLayer:
    ...
    def __init__(self, **kwargs):
        ...
        sort_by_duration = kwargs.get("sort_by_duration", False)
