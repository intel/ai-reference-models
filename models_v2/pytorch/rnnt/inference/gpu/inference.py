...
def parse_args():
    ...
    parser.add_argument(
        "--fp16", action="store_false", help="use half precision", default=False
    )
    parser.add_argument(
    ...
    with torch.no_grad():
        ...
        for it, data in enumerate(tqdm(data_layer.data_iterator)):
            ...
            t_predictions_e = greedy_decoder.decode(
                t_audio_signal_e, t_a_sig_length_e, args
            )
    ...
    with torch.no_grad():
        ...
        for it, data in enumerate(tqdm(data_layer.data_iterator)):
            ...
            torch.save(
                ...
                profiling_path + "rnnt_inference_profiling.pt",
            )
...
def main(args):
    ...
    if args.fp16:
        model = amp.initialize(models=model, opt_level=AmpOptimizations[optim_level])
