...
ARG TF_MODELS_BRANCH="7a9934df2afdf95be9405b4e9f1f2480d748dc40"
...
WORKDIR /workspace/intel-tf-object-detection-preprocess-coco-val 

COPY datasets/coco scripts
