...
COPY quickstart/image_recognition/pytorch/resnet50/inference/cpu/inference_realtime.sh quickstart/inference_realtime.sh
COPY quickstart/image_recognition/pytorch/resnet50/inference/cpu/inference_throughput.sh quickstart/inference_throughput.sh
COPY quickstart/image_recognition/pytorch/resnet50/inference/cpu/accuracy.sh quickstart/accuracy.sh
