...
COPY quickstart/image_recognition/tensorflow/resnet50v1_5/inference/cpu/accuracy.sh quickstart/accuracy.sh
COPY quickstart/image_recognition/tensorflow/resnet50v1_5/inference/cpu/inference_throughput_multi_instance.sh quickstart/inference_throughput.sh
COPY quickstart/image_recognition/tensorflow/resnet50v1_5/inference/cpu/inference_realtime_multi_instance.sh quickstart/inference_realtime.sh
COPY quickstart/image_recognition/tensorflow/resnet50v1_5/inference/cpu/inference_realtime_weightsharing.sh quickstart/inference_realtime_weightsharing.sh
