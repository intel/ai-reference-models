...
# TF_SERVING_VERSION=1.13.0 MKL_IMAGE_TAG=tensorflow/serving:latest-mkl bash build_tfserving_image.sh
...
git clone -b ${TF_SERVING_VERSION} https://github.com/tensorflow/serving.git
