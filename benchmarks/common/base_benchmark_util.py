...
class BaseBenchmarkUtil(object):
    ...
    def _validate_args(self):
        ...
        system_num_cores = (
            num_logical_cores_per_socket
            if args.socket_id != -1
            else num_logical_cores_per_socket * self._platform_util.num_cpu_sockets
        )
        ...
        if args.output_results and (
            ...
            raise ValueError(
                "--output-results is currently only supported for resnet50 FP32 inference."
            )
