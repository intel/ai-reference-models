...
class ModelInitializer(BaseModelInitializer):
    """Model Initializer for MMoE training"""
    ...
    def __init__(self, args, custom_args=[], platform_util=None):
        ...
        arg_parser.add_argument("--train-epochs", dest='train_epochs',
                                type=int, default=25,
                                help="number of epochs")
        arg_parser.add_argument("--output-dir", dest='output_dir',
                                type=str, default='/tmp/mmoe/',
        ...
        benchmark_script = os.path.join(
            self.args.intelai_models, self.args.mode, "train.py")
        ...
        self.benchmark_command = \
            ...
            " --train-epochs=" + str(self.args.train_epochs) + \
