...
tf.app.flags.DEFINE_string('data_dir', '', 'path to images in TF records format')
tf.app.flags.DEFINE_string('model', 'resnet50', 'Name of model (resnet50 or inceptionv3).')
...
def main(_):
    ...
    for _ in range(num_iteration):
        ...
        request.inputs['input'].CopyFrom(
            tf.contrib.util.make_tensor_proto(image_np, shape=[FLAGS.batch_size, image_size, image_size, 3]))
