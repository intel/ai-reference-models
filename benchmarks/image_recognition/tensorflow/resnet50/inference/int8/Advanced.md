...
# ResNet50 Int8 inference - Advanced Instructions

<!-- 10. Description -->
This document has advanced instructions for running ResNet50 Int8
...
ResNet50 Int8 inference can be run to test accuracy, batch inference, or online inference.
