...
class ResNet50V1ModelInitializer(BaseModelInitializer):
    """initialize mode and run benchmark"""

    def __init__(self, args, custom_args=[], platform_util=None):
        super(ResNet50V1ModelInitializer, self).__init__(
        ...
        benchmark_script = "-m " + self.args.model_source_dir + \
                           "/models/official/resnet/resnet_main"
        ...
        self.benchmark_command = \
            ...
            " --train_batch_size=" + str(self.args.batch_size) + \
            " --train_steps=" + str(self.args.steps)

        #TODO(nhasbani): add inter_op and intra_op support to the model to pass
        # these args.
        ...
        if self.args.checkpoint == None:
            self.args.checkpoint = "/tmp/log"
            print("Training checkpoints and output will be stored in",
