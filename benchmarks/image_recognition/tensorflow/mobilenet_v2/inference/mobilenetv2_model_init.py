...
class MobilenetV2ModelInitializer(BaseModelInitializer):
    """ Model initializer for MobileNet V2 inference """

    def __init__(self, args, custom_args=[], platform_util=None):
        super(MobilenetV2ModelInitializer, self).__init__(args, custom_args, platform_util)
    ...
    def parse_args(self):
        ...
        parser.add_argument(
            ...
            type=str, default="MobilenetV2/Predictions/Reshape_1")
