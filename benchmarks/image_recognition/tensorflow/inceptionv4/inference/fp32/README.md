...
./quickstart/image_recognition/tensorflow/inceptionv4/inference/cpu/fp32/<script name>.sh
```
...
bash quickstart\image_recognition\tensorflow\inceptionv4\inference\cpu\fp32\<script name>.sh
```
