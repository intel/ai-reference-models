...
class ModelInitializer(BaseModelInitializer):
    """Model initializer for InceptionV4 Int8 inference"""
    ...
    def __init__(self, args, custom_args=[], platform_util=None):
        ...
        os.environ["OMP_NUM_THREADS"] = "{}".format(
            platform_util.num_cores_per_socket() if self.args.num_cores == -1
            else self.args.num_cores)
        os.environ["KMP_BLOCKTIME"] = "0"
        os.environ["KMP_SETTINGS"] = "1"
        os.environ["KMP_AFFINITY"] = "granularity=fine,verbose,compact,1,0"
        self.args.num_inter_threads = platform_util.num_threads_per_core()
