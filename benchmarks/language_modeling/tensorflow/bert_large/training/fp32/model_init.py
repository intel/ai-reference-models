...
class ModelInitializer(BaseModelInitializer):
    ...
    def __init__(self, args, custom_args=[], platform_util=None):
        ...
        arg_parser.add_argument('--train-option', help=' Training SQuAD, Pretraining or classifier', dest="train_option", default='SQuAD')
        ...
        arg_parser.add_argument('--do-lower-case', help=' Use lowercase for data', dest="do_lower_case", default="False")

        arg_parser.add_argument('--vocab-file', help=' Vocabulary file for BERT', dest="vocab_file", default='vocab.txt')
        ...
        arg_parser.add_argument('--num-train-steps', help=' Number of steps to train ', dest="num_train_steps", type=int, default=20)
        arg_parser.add_argument('--warmup-steps', help=' Number of warmup steps', dest="warmup_steps", type=int, default=10)
        arg_parser.add_argument('--max-predictions', help=' max predictions:pretraining', dest="max_predictions", type=int, default=20)
        ...
        arg_parser.add_argument('--accum_steps', help=' Steps before Gradient Accumulation ', dest="accum_steps", type=int, default=1)
        ...
        arg_parser.add_argument('--experimental-gelu', help=' [Experimental] Use experimental gelu op.', dest="experimental_gelu", default="False")
