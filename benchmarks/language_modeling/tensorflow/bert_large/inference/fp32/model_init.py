...
class ModelInitializer(BaseModelInitializer):
    ...
    def __init__(self, args, custom_args=[], platform_util=None):
        ...
        if not self.args.input_graph:
            sys.exit(
                "ERROR: BERT large FP32 inference requires a frozen graph to be passed "
        ...
        arg_parser.add_argument(
            "--weight-sharing", dest="weight_sharing", action="store_false"
        )
        ...
        if not self.args.gpu:
            if self.args.init_checkpoint and not os.path.isabs(
        ...
        model_args += " --num_cores_per_socket=" + str(
