...
#
Copy-item -Path "../../cloud_data_connector/gcp/README.md" -Destination "./GCP_README.md"
Copy-item -Path "../../cloud_data_connector/azure/AzureML.md" -Destination "./AZUREML_README.md"
Copy-item -Path "../../cloud_data_connector/aws/README.md" -Destination "./AWS_README.md"
