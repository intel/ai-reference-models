...
def main():
    ...
    parser.add_argument('--detections_path', type=str, required=True,
                        help='path to the input detected bounding box files')
    parser.add_argument('--annotations_file', type=str, required=True,
                        help='name of the input validation annotations file')
