...
def get_examples_per_second_hook(
    every_n_steps=100, batch_size=128, warm_steps=500, **kwargs
):  # pylint: disable=unused-argument
    ...
    return hooks.ExamplesPerSecondHook(
        every_n_steps=every_n_steps, batch_size=batch_size, warm_steps=warm_steps
    )


def get_logging_metric_hook(
    benchmark_log_dir=None, tensors_to_log=None, every_n_secs=600, **kwargs
):  # pylint: disable=unused-argument
    ...
    return metric_hook.LoggingMetricHook(
        tensors=tensors_to_log, log_dir=benchmark_log_dir, every_n_secs=every_n_secs
    )
