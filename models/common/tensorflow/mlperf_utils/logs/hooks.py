...
class ExamplesPerSecondHook(tf.estimator.SessionRunHook):
    ...
    def __init__(self, batch_size, every_n_steps=None, every_n_secs=None, warm_steps=0):
            ...
            if elapsed_time is not None:
                ...
                if global_step > self._warm_steps:
                    ...
                    tf.compat.v1.logging.info(
                        "Batch [%g]:  last %g steps exp/sec = %g, total average exp/sec = "
                        "%g",
                        self._total_steps,
                        elapsed_steps,
                    ...
                    tf.compat.v1.logging.info(
                        "Batch [%g]:  last %g steps exp/sec = %g, completed %g/%g warmup steps",
                        self._total_steps,
                        elapsed_steps,
                        current_examples_per_sec,
                        self._total_steps,
