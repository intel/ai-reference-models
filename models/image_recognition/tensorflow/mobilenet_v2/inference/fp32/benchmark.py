...
def load_graph(model_file, input_layer, output_layer):
  graph = tf.Graph()
  ...
  output_graph = optimize_for_inference(graph_def, [input_layer], 
                            [output_layer], dtypes.float32.as_datatype_enum, False)
...
if __name__ == "__main__":
  ...
  graph = load_graph(model_file, input_layer, output_layer)
