...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_layer",
        default="densenet169/predictions/Reshape_1",
    ...
    parser.add_argument(
        ...
        default=-1,
        type=int,
        help="Run on gpu, other wise cpu",
        required=False,
    )

    parser.add_argument(
        "--warmup_steps", type=int, default=40, help="number of warmup steps"
    )
    ...
    with data_graph.as_default():  ##
        ...
        images = tf.random.truncated_normal(
            input_shape, dtype=tf.float32, stddev=10, name="synthetic_images"
        )
    ...
    with tf.compat.v1.Session(graph=graph, config=config) as sess:
        ...
        for t in range(steps):
            ...
            if (t + 1) % 10 == 0:
                ...
                print("       Latency: {0} ms" "".format(avg * 1000.0 / (t + 1)))
