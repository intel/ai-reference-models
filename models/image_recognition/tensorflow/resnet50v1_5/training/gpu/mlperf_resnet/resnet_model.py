...
def _bottleneck_block_v1(
    ...
    if projection_shortcut is not None:
        ...
        resnet_log_helper.log_projection(input_tensor=inputs, output_tensor=shortcut)
        shortcut = batch_norm(
    ...
    def __call__(self, inputs, training):
        ...
        with self._model_variable_scope():
            ...
            if self.first_pool_size:
                ...
                resnet_log_helper.log_max_pool(
                    input_tensor=inputs, output_tensor=pooled_inputs
                )
            ...
            mlperf_log.resnet_print(
                key=mlperf_log.MODEL_HP_DENSE, value=self.num_classes
            )
