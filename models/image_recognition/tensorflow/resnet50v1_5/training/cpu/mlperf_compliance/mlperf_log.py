...
def gnmt_print(key, value=None, stack_offset=1, deferred=False, prefix=""):
    return _mlperf_print(
        ...
        tag_set=GNMT_TAG_SET,
        deferred=deferred,
        root_dir=ROOT_DIR_GNMT,
    )
...
def maskrcnn_print(
    key, value=None, stack_offset=1, deferred=False, extra_print=True, prefix=""
):
    return _mlperf_print(
        key=key,
        value=value,
...
def minigo_print(key, value=None, stack_offset=1, deferred=False, prefix=""):
    return _mlperf_print(
        ...
        benchmark=MINIGO,
        stack_offset=stack_offset,
        tag_set=MINIGO_TAG_SET,
        deferred=deferred,
        root_dir=ROOT_DIR_MINIGO,
        prefix=prefix,
    )
...
def resnet_print(key, value=None, stack_offset=1, deferred=False, prefix=""):
    return _mlperf_print(
        ...
        benchmark=RESNET,
        stack_offset=stack_offset,
        tag_set=RESNET_TAG_SET,
        deferred=deferred,
        root_dir=ROOT_DIR_RESNET,
        prefix=prefix,
    )
