...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_location", default=None, help="dataset location")
    ...
    parser.add_argument(
        "--num_cores", default=28, type=int, help="number of physical cores"
    )
    parser.add_argument(
        "--num_inter_threads",
    ...
    print(
        "Average throughput for batch size {0}: {1} images/sec".format(
            batch_size, total_images / total_time
        )
    )
