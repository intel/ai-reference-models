...
flags.DEFINE_string("precision", "fp16", "[Optional] TensorFlow training precision.")
...
flags.DEFINE_integer(
    "intra_op_parallelism_threads", 20, "Setting intra op for the model"
)
    ...
    def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            train_op = optimization.create_optimizer(
                ...
                amp=bert_config.amp,
                use_tpu=False,
                use_multi_cpu=(is_mpi if FLAGS.mpi_workers_sync_gradients else 0),
            )
...
def validate_flags_or_throw(bert_config):
    ...
    bert_config.set_additional_options(
        FLAGS.precision, FLAGS.experimental_gelu, FLAGS.optimized_softmax, FLAGS.amp
    )
