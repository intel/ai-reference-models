  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    if mode == tf.estimator.ModeKeys.TRAIN:
      ...
      train_op = optimization.create_optimizer(
          total_loss, learning_rate, num_train_steps, num_warmup_steps, accum_steps=1, amp=bert_config.amp, use_tpu=False, use_multi_cpu=(is_mpi if FLAGS.mpi_workers_sync_gradients else 0))
