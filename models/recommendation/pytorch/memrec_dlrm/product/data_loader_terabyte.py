...
def _test_bin():
    ...
    dataset_binary = CriteoBinDataset(data_file=binary_data_file,
                                            ...
                                            batch_size=2048,)
    from models.recommendation.pytorch.memrec.product.memrec_data import CriteoDataset 
    from models.recommendation.pytorch.memrec.product.memrec_data import collate_wrapper_criteo_offset as collate_wrapper_criteo
