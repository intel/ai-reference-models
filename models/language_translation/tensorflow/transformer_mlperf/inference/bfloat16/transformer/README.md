# Transformer Translation Model
 ...
 Some model python files have bfloat16 cast ops added files by Intel in order to run the model with bfloat16 support.
...
### Run bfloat16 inference:
This model has been manually changed to bfloat16 inference. In order to improve the performance, we add a new script to generate a frozen model from a fully trained model checkpoint.
