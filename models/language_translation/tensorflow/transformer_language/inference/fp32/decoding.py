...
def decode_from_file(estimator,
  ...
  if decode_hp.batch_size is 1:
    print('  Inference time %.4f, Latency = %.4f ms/setences' % (duration, 1000.0*duration/num_sentences))
  else:
    print('  Inference time %.4f, Throughput = %.4f sentences/second' % (duration, num_sentences/duration))
