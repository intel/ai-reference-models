...
throughput=$(grep 'Throughput:' ${OUTPUT_DIR}/LCM_${PRECISION}_inference_realtime* |sed -e 's/.*Throughput//;s/[^0-9.]//g' |awk -v INSTANCES_PER_SOCKET=$INSTANCES_PER_SOCKET '
BEGIN {
        sum = 0;
        i = 0;
      }
...
echo ""LCM";"latency";$1;${throughput}" | tee -a ${OUTPUT_DIR}/summary.log
