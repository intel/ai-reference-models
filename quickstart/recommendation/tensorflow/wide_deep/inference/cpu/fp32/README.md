...
[wide-deep-fp32-inference.tar.gz](https://storage.googleapis.com/intel-optimized-tensorflow/models/v2_4_0/wide-deep-fp32-inference.tar.gz)
...
1. Download and untar the Wide & Deep FP32 inference model package:
    ...
    ```
    wget https://storage.googleapis.com/intel-optimized-tensorflow/models/v2_4_0/wide-deep-fp32-inference.tar.gz
