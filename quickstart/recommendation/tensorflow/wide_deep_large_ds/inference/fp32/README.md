...
[wide-deep-large-ds-fp32-inference.tar.gz](https://storage.googleapis.com/intel-optimized-tensorflow/models/v2_1_0/wide-deep-large-ds-fp32-inference.tar.gz)
...
* Launch docker 
    ...
    docker run -it --privileged -u root:root \
               ...
               intel/recommendation:tf-1.15.2-imz-2.1.0-wide-deep-large-ds-fp32-inference \
               /bin/bash
