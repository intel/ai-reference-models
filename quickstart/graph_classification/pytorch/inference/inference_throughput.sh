...
rm -rf ${OUTPUT_DIR}/rgat_${PRECISION}_inference_throughput*

python -m intel_extension_for_pytorch.cpu.launch \
    --use_default_allocator \
    --throughput_mode \
    --log_path ${OUTPUT_DIR} \
    --log_file_prefix rgat_${PRECISION}_inference_throughput \
...
throughput=$(grep 'Throughput:' ${OUTPUT_DIR}/rgat_${PRECISION}_inference_throughput* |sed -e 's/.*Throughput//;s/[^0-9.]//g' |awk '
BEGIN {
        sum = 0;
i = 0;
      }
