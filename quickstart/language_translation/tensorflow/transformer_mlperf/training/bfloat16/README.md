...
[transformer-mlperf-bfloat16-training.tar.gz](https://storage.googleapis.com/intel-optimized-tensorflow/models/v2_1_0/transformer-mlperf-bfloat16-training.tar.gz)
...
```
wget https://storage.googleapis.com/intel-optimized-tensorflow/models/v2_1_0/transformer-mlperf-bfloat16-training.tar.gz
...
docker run \
  ...
  --privileged --init -t \
  intel/language-translation:tf-2.3.0-imz-2.1.0-transformer-mlperf-bfloat16-training \
