...
The model container `intel/image-recognition:tf-2.3.0-mobilenet-v1-fp32-inference` includes the scripts
...
docker run \
  ...
  --privileged --init -t \
  intel/image-recognition:tf-2.3.0-mobilenet-v1-fp32-inference \
