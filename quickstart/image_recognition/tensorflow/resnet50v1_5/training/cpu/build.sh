...
DOCKERFILE=tf-spr-resnet50v1-5-training.Dockerfile
...
if [ "$(docker images -q ${TF_SPR_BASE_IMAGE}:${TF_SPR_BASE_TAG})" == "" ]; then
  ...
  echo "This container is required, as it is used as the base for building the ResNet50 v1.5 training container."
