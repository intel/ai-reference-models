...
The model container `intel/image-recognition:tf-2.3.0-resnet50v1-5-fp32-inference` includes the scripts
...
docker run \
  ...
  --privileged --init -t \
  intel/image-recognition:tf-2.3.0-resnet50v1-5-fp32-inference \
