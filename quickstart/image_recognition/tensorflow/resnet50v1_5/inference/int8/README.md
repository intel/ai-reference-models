...
The model container `intel/image-recognition:tf-2.3.0-resnet50v1-5-int8-inference` includes the scripts and libraries needed to run
...
docker run \
  ...
  --privileged --init -t \
  intel/image-recognition:tf-2.3.0-resnet50v1-5-int8-inference \
