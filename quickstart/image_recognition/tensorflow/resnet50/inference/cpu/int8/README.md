...
[resnet50-int8-inference.tar.gz](https://storage.googleapis.com/intel-optimized-tensorflow/models/v2_4_0/resnet50-int8-inference.tar.gz)
...
wget https://storage.googleapis.com/intel-optimized-tensorflow/models/v2_4_0/resnet50-int8-inference.tar.gz
