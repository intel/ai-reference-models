...
[resnet50-fp32-inference.tar.gz](https://storage.googleapis.com/intel-optimized-tensorflow/models/v2_4_0/resnet50-fp32-inference.tar.gz)
...
wget https://storage.googleapis.com/intel-optimized-tensorflow/models/v2_4_0/resnet50-fp32-inference.tar.gz
...
The model container `intel/image-recognition:tf-latest-resnet50-fp32-inference` includes the scripts
