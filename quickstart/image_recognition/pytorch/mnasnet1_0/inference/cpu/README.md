# MNASNet 1.0 Inference

## Description

This document has instructions for running MNASNet 1.0 inference.

## Datasets

### ImageNet

The [ImageNet](http://www.image-net.org/) validation dataset is used to run MNASNet 1.0
accuracy tests.
...
* Run the model:
  ...
  bash quickstart/image_recognition/pytorch/mnasnet1_0/inference/cpu/batch_inference_baremetal.sh fp32
  ```
