...
This document has instructions for running GoogLeNet inference.

## Datasets

### ImageNet

The [ImageNet](http://www.image-net.org/) validation dataset is used to run GoogLeNet
accuracy tests.
...
* Run the model:
  ...
  bash quickstart/image_recognition/pytorch/googlenet/inference/cpu/batch_inference_baremetal.sh fp32
  ```
