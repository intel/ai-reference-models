# Wide ResNet-50-2 Inference

## Description

This document has instructions for running Wide ResNet-50-2 inference.

## Datasets

### ImageNet

The [ImageNet](http://www.image-net.org/) validation dataset is used to run Wide ResNet-50-2
accuracy tests.
...
* Run the model:
  ...
  bash quickstart/image_recognition/pytorch/wide_resnet50_2/inference/cpu/batch_inference_baremetal.sh fp32
  ```
