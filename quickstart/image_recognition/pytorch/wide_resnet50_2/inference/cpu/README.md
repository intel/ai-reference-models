...
This document has instructions for running Wide ResNet-50-2 inference using
...
cd ${MODEL_DIR}/quickstart/image_recognition/pytorch/wide_resnet50_2/inference/cpu
