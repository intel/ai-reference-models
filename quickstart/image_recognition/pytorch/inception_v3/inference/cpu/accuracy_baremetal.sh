...
python -m intel_extension_for_pytorch.cpu.launch \
  ...
  --log_path=${OUTPUT_DIR} \
  --log_file_prefix="inception_v3_accuracy_log_${PRECISION}" \
...
accuracy=$(grep 'Accuracy:' ${OUTPUT_DIR}/inception_v3_accuracy_log_${PRECISION}_* |sed -e 's/.*Accuracy//;s/[^0-9.]//g')
echo "inception_v3;"accuracy";${PRECISION};${BATCH_SIZE};${accuracy}" | tee -a ${OUTPUT_DIR}/summary.log
