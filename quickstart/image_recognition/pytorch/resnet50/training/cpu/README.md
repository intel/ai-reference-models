...
```bash
    export GLOBAL_BATCH_SIZE=#global batch_size (or export LOCAL_BATCH_SIZE=#local batch_size)(for lars optimizer convergency test, the GLOBAL_BATCH_SIZE should be 3264)
