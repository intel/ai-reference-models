...
## Pull Command
```
docker pull intel/image-recognition:pytorch-spr-resnet50-training
```
...
IMAGE_NAME=intel/image-recognition:pytorch-spr-resnet50-training
...
[Get Started Guide](https://github.com/IntelAI/models/blob/master/quickstart/quickstart/image_recognition/pytorch/resnet50/training/cpu/README_SPR_DEV_CAT.md)
