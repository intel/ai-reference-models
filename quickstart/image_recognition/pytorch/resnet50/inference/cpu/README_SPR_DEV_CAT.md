...
## Pull Command
```
docker pull intel/image-recognition:pytorch-spr-resnet50-inference
```
...
IMAGE_NAME=intel/image-recognition:pytorch-spr-resnet50-inference
...
[Get Started Guide](https://github.com/IntelAI/models/blob/master/quickstart/quickstart/image_recognition/pytorch/resnet50/inference/cpu/README_SPR_DEV_CAT.md)
