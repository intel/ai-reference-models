...
if [[ $PRECISION == "int8" ]]; then
    bash run_accuracy_ipex.sh resnext101_32x16d_swsl $DATASET_DIR int8 no_jit resnext101_configure.json 2>&1 | tee -a ${OUTPUT_DIR}/resnext-32x16d-inference-accuracy-int8.log
