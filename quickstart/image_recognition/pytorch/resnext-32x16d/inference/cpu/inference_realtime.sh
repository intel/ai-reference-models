...
if [[ $PRECISION == "int8" ]]; then
    bash run_multi_instance_latency_ipex_spr.sh resnext101_32x16d_swsl int8 no_jit resnext101_configure.json 2>&1 | tee -a ${OUTPUT_DIR}/resnext-32x16d-inference-realtime-int8.log
