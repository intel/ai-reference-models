# VGG-11 with batch normalization Inference

## Description

This document has instructions for running VGG-11 with batch normalization inference.

## Datasets

### ImageNet

The [ImageNet](http://www.image-net.org/) validation dataset is used to run VGG-11 with batch normalization
accuracy tests.
...
* Run the model:
  ...
  bash quickstart/image_recognition/pytorch/vgg11_bn/inference/cpu/batch_inference_baremetal.sh fp32
  ```
## Run on Windows
