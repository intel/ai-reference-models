...
This document has instructions for running VGG-11 inference using
...
The [ImageNet](http://www.image-net.org/) validation dataset is used to run VGG-11
accuracy tests.
...
cd ${MODEL_DIR}/quickstart/image_recognition/pytorch/vgg11/inference/cpu
