# ResNext-32x4d Inference

## Description

This document has instructions for running ResNext-32x4d inference.

## Datasets

### ImageNet

The [ImageNet](http://www.image-net.org/) validation dataset is used to run ResNext-32x4d
accuracy tests.
...
* Run the model:
  ...
  bash quickstart/image_recognition/pytorch/resnext-32x4d/inference/cpu/batch_inference_baremetal.sh fp32
  ```
