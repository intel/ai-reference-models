...
if [[ "0" == ${TORCH_INDUCTOR} ]];then
    ...
    python -m intel_extension_for_pytorch.cpu.launch --nodes-list 0 --memory-allocator tcmalloc --log_dir=${OUTPUT_DIR} --log_file_prefix="./GPT-J_${precision}_accuracy_${mode}" \
        ${EVAL_SCRIPT} $ARGS \
