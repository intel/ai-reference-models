...
cd <clone of the AI Reference Models>/quickstart/language_modeling/pytorch/llama/inference/cpu
...
mv prompt.json <clone of the AI Reference Models>/models/language_modeling/pytorch/llama/inference/cpu
