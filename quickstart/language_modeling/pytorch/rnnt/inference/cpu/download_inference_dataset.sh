...
MODEL_DIR=$(pwd)/models/rnnt/training/rnn_speech_recognition/pytorch
cd $MODEL_DIR
...
cd $MODEL_DIR
python utils/download_librispeech.py utils/inference_librispeech.csv $DATASET_DIR -e $DATASET_DIR
