...
[faster_rcnn-int8-inference.tar.gz](https://storage.googleapis.com/intel-optimized-tensorflow/models/v2_4_0/faster-rcnn-int8-inference.tar.gz)
...
```
wget https://storage.googleapis.com/intel-optimized-tensorflow/models/v2_4_0/faster-rcnn-int8-inference.tar.gz
