...
[ssd-resnet34-bfloat16-training.tar.gz](https://storage.googleapis.com/intel-optimized-tensorflow/models/v2_2_0/ssd-resnet34-bfloat16-training.tar.gz)
...
* Cython
* horovod
* [intel-tensorflow==2.5](https://pypi.org/project/intel-tensorflow/)
* jupyter
* lxml
* matplotlib
* numpy==1.17.4
...
wget https://storage.googleapis.com/intel-optimized-tensorflow/models/v2_2_0/ssd-resnet34-bfloat16-training.tar.gz
...
docker run \
  ...
  --privileged --init -it \
  intel/object-detection:tf-2.3.0-imz-2.2.0-ssd-resnet34-bfloat16-training \
