...
accuracy=$(grep 'Accuracy:' ${OUTPUT_DIR}/train_ssdresnet34_${PRECISION}_accuracy_dist* |sed -e 's/.*Accuracy//;s/[^0-9.]//g')
echo ""SSD-RN34";"distributed accuracy";$1; ${BATCH_SIZE};${accuracy}" | tee -a ${OUTPUT_DIR}/summary.log
