...
rm -rf ${OUTPUT_DIR}/retinanet_resnet50_fpn_accuracy_log_${PRECISION}_*

python -m intel_extension_for_pytorch.cpu.launch \
  --use_default_allocator \
  --log_path=${OUTPUT_DIR} \
  --log_file_prefix="retinanet_resnet50_fpn_accuracy_log_${PRECISION}" \
...
accuracy=$(grep 'Bbox AP:' ${OUTPUT_DIR}/retinanet_resnet50_fpn_accuracy_log_${PRECISION}_* |sed -e 's/.*Bbox AP//;s/[^0-9.]//g')
echo "retinanet_resnet50_fpn;"Bbox AP";${PRECISION};${BATCH_SIZE};${accuracy}" | tee -a ${OUTPUT_DIR}/summary.log