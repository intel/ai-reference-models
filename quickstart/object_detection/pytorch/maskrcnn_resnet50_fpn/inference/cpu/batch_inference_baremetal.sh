...
rm -rf ${OUTPUT_DIR}/maskrcnn_resnet50_fpn_throughput_log_${PRECISION}_*
...
throughput=$(grep 'Throughput:' ${OUTPUT_DIR}/maskrcnn_resnet50_fpn_throughput_log_${PRECISION}_* |sed -e 's/.*Throughput//;s/[^0-9.]//g' |awk '
BEGIN {
        sum = 0;
        i = 0;
      }
...
echo "maskrcnn_resnet50_fpn;"throughput";${PRECISION};${BATCH_SIZE};${throughput}" | tee -a ${OUTPUT_DIR}/summary.log